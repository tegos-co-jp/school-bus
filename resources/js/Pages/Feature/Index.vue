...
const createClick = () => {
    Inertia.get(route("feature.create"));
};
const editClick = (data:Array) => {
    Inertia.get(route("feature.edit",data));
};
const deleteClick = (data:Array) => {
    Inertia.delete(route("feature.destroy",data.id));
};
</script>
...
<template>
    <div>
        <div class="card">
            ...
            <DataTable :value="features.data" 
                :paginator="true" :rows="10" :filters="filters"
                paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown" :rowsPerPageOptions="[5,10,25]"
                currentPageReportTemplate="Showing {first} to {last} of {totalRecords} features" responsiveLayout="scroll">
                <template #header>
                ...
                <Column field="name" header="機能名" :sortable="true" style="min-width:16rem"></Column>

    ...
    <div>
        <div class="card">
            ...
            <DataTable :value="schools" 
                ...
                <Column field="code" header="Code" :sortable="true" style="min-width:4rem"></Column>
                <Column field="name" header="Name" :sortable="true" style="min-width:16rem"></Column>
<!-- 
                <Column field="zip_code" header="zip_code" :sortable="true" style="min-width:7rem"></Column>
                <Column field="address" header="address" :sortable="true" style="min-width:20rem"></Column>
                <Column field="representative_name" header="representative_name" :sortable="true" style="min-width:16rem"></Column>
 -->
                <Column field="phone_number" header="phone_number" :sortable="true" style="min-width:16rem"></Column>
